    ...
    return (
        <article className="relative max-w-[1920px] mx-auto py-4">
            <div className={`h-[calc(50vh-2rem)] relative ${post.image ? 'mb-44' : ''}`}>
                ...
                {/* Hero Section */}
                {post.image ? (
                    <div className="absolute top-36 left-1/2 w-full max-w-3xl transform -translate-x-1/2">
                        <div className="relative h-[450px] lg:aspect-video w-[calc(100%-2rem)] mx-4 lg:w-full lg:mx-0">
                            <Image
                                src={post.image}
                                alt="Header Image"
                                fill
